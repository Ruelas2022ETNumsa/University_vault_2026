---
title: "Biblioteca ETN607 — Guía de libros"
galaxy_body: beacon
scope: vault
audience: usuario
related_notes:
...
Enseñar al estudiante la Dinámica Clásica mediante las ecuaciones de LaGrange, que es un método energético, más versátil y sencillo que los métodos tradicionales, incluido el de Newton, para analizar las ecuaciones de movimiento de sistemas mecánicos clásicos y también para sistemas eléctricos.

---

## Temario oficial

### T1 — CONCEPTOS BASICOS I
...
- Tipos de Problemas.-
- Metodología tratamiento problemas dinámicos.

### T2. CONCEPTOS BASICOS II

- Observaciones Introductorias
- Sistemas Coordenadas y Ec — de Transformación.
	- Sistema de Coordenadas Rectangular
	- Sistema de Coordenadas Cilíndricas (r, q, z)
	- Sistema de Coordenadas Esféricas (r, q, f)
	- Otros Sistemas de Coordenadas
- Coordenadas Generalizadas.
- Grados de Libertad (N)
	- Grados de Libertad de una Partícula
	- Grados de Libertad de una Varilla
	- Grados de Libertad de un Cuerpo Rígido
- Restricciones y Ecuaciones de Restricción
	- Restricciones y Ec. Restricción – Movimiento en el Plano
	- Restricciones y Ec. Restricción – Movimiento en una línea
	- Otras Restricciones
- Vector Velocidad
- Escalar Velocidad
...
### T3 — ECUACIONES DE LAGRANGE PARA UNA PARTICULA
...
### T4 — EC DE LAGRANGE PARA UN SISTEMAS DE PARTICULAS
...
### T7 — ECUACIONES DE LAGRANGE PARA CIRCUITOS ELECTRICOS
