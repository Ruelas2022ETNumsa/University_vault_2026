...
| Intervalo             | Prueba x | Signo i               | $R_{i}$ | Signo ii              | $R_{ii}$ |
| --------------------- | -------- | --------------------- | ------- | --------------------- | -------- |
| $]-\infty,-\frac54[$  | $-10$    | $\frac{(-)}{(-)}=(+)$ | V       | $\frac{(-)}{(-)}=(+)$ | V        |
| $]-\frac54,-\frac23[$ | $-1$     | $\frac{(-)}{(-)}=(+)$ | V       | $\frac{(+)}{(-)}=(-)$ | F        |
| $]-\frac23,-\frac38[$ | $-0.5$   | $\frac{(-)}{(+)}=(-)$ | F       | $\frac{(+)}{(+)}=(+)$ | V         |
| $]-\frac38,+\infty[$  | $10$     | $\frac{(+)}{(+)}=(+)$ | V       | $\frac{(+)}{(+)}=(+)$ | V        |
