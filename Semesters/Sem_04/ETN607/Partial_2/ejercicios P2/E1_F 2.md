...
> **Descripción de la figura:** $m_1$ (teal) reposa sobre el piso y está conectada a la pared izquierda por el resorte $K$. Un cable horizontal parte del lado derecho de $m_1$, rodea la polea fija en el borde derecho del piso y desciende verticalmente. $m_2$ (teal) y $m_3$ (naranja) deslizan rozando la pared vertical izquierda con coeficientes viscosos $b_2$ y $b_3$ respectivamente. El resorte $K'$ conecta la base de $m_2$ con la parte superior de $m_3$. Las coordenadas $x_1$ (horizontal, desde la pared hasta el centro de $m_1$), $y_2$ e $y_3$ (verticales, desde la polea hasta el centro de $m_2$ y $m_3$) se indican con flechas.
