...
**Paso 5 — Ecuación de Euler-Lagrange** *(regla de la cadena sobre $y_1(y_2)$ e $y_3(y_2)$)*
...
$$
\dfrac{\partial L}{\partial y_2} = \underbrace{\dfrac{1}{2}}_{\partial y_1/\partial y_2}\!\left[m_1 g - K(y_1 - \ell_0)\right] + m_2 g + \underbrace{2}_{\partial y_3/\partial y_2}\!\left[m_3 g + K'\!\left(H - y_3 - \pi R_3 - \ell_0'\right)\right]
$$

**Paso 6 — Sustitución de ligaduras en posición** *(para expresar todo en $y_2$)*

$$
y_1 = \dfrac{y_2}{2} + C_1 \qquad y_3 = 2y_2 + C_2
$$
...
**Paso 7 — Ecuación de movimiento**

$$
\boxed{\left(\dfrac{m_1}{4} + m_2 + 4m_3\right)\ddot{y}_2 + \left(\dfrac{K}{4} + 4K'\right)y_2 = \left(\dfrac{m_1}{2} + m_2 + 2m_3\right)g - \dfrac{K}{2}(C_1 - \ell_0) + 2K'\!\left(H - C_2 - \pi R_3 - \ell_0'\right)}
$$
