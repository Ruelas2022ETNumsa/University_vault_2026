...
Debido al exponente par en $(x-0)^2$, el signo no se alterna al pasar por $0$.
...
Desarrollo transcrito del manuscrito:
$$\begin{array}{rcll}
...
**Condición 1:** $\dfrac{2x-1}{3x+2} < 2$ $$\begin{array}{rcll} \dfrac{2x-1}{3x+2} - 2 & < & 0 & (\text{transposición})\\\dfrac{2x-1-2(3x+2)}{3x+2} & < & 0 & (\text{común denominador})\\\dfrac{-4x-5}{3x+2} & < & 0 & (\text{simplificación}) \end{array}$$ Puntos críticos: $x = -\dfrac{5}{4}$, $x = -\dfrac{2}{3}$. Prueba con $x=0$: $\dfrac{(-)}{(+)} = (-) < 0$ (Verdad).
...
**Condición 2:** $\dfrac{2x-1}{3x+2} > -2$ $$\begin{array}{rcll} \dfrac{2x-1}{3x+2} + 2 & > & 0 & (\text{transposición})\\\dfrac{2x-1+6x+4}{3x+2} & > & 0 & (\text{común denominador})\\\dfrac{8x+3}{3x+2} & > & 0 & (\text{simplificación}) \end{array}$$ Puntos críticos: $x = -\dfrac{3}{8}$, $x = -\dfrac{2}{3}$. Prueba con $x=0$: $\dfrac{(+)}{(+)} = (+) > 0$ (Verdad).
