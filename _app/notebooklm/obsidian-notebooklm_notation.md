...
Dentro de tablas Markdown, el carácter `|` es el separador de columnas
y no puede usarse dentro de expresiones matemáticas. Por eso:

- Valor absoluto → `$\vert x \vert# Guía de notación Obsidian para NotebookLM
...
y no puede usarse dentro de expresiones matemáticas. Por eso:
 ...
 (nunca `|x|` dentro de tablas)
- Norma vectorial → `$\Vert v \Vert# Guía de notación Obsidian para NotebookLM
