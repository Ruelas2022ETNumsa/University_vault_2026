...
Jerarquía de consulta:
  1. Hill & Peterson Digital Systems 2ª ed. (fotocopias) — fuente base T4
  2. Libro secundario según el tema (ver tabla por tema abajo)
...
Hill & Peterson — Digital Systems 2ª ed.:
  tema T4 → `825 Hill Peterson Digital Systems Hardware Organization Design 9-10-11-13.pdf`
...
T4 — Interfaces y periféricos → Hill & Peterson Digital Systems 2ª ed. (PDF T4) · Hamacher 6ª
