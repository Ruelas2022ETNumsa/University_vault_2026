...
**Varianzas:** $$E[X^2] = 1^2\cdot\frac{15}{28}+2^2\cdot\frac{3}{28} = \frac{27}{28}$$ $$VAR[X] = \frac{27}{28}-\left(\frac{3}{4}\right)^2 = \frac{108-63}{112} = \frac{45}{112}$$

$$E[Y^2] = 1^2\cdot\frac{12}{28}+2^2\cdot\frac{1}{28} = \frac{16}{28}$$ $$VAR[Y] = \frac{4}{7}-\frac{1}{4} = \frac{16-7}{28} = \frac{9}{28}$$

**Coeficiente de correlación:** $$\rho_{XY} = \frac{COV[X,Y]}{\sqrt{VAR[X]\cdot VAR[Y]}} = \frac{-9/56}{\sqrt{\dfrac{45}{112}\cdot\dfrac{9}{28}}} = \frac{-9/56}{\dfrac{9\sqrt{5}}{56}}$$
...
Cada resultado del espacio muestral tiene probabilidad $\tfrac{1}{8}$.

**Mapeo del espacio muestral:**
...
$$P_X(x) = \binom{3}{x}!\left(\frac{1}{2}\right)^3, \quad x=0,1,2,3 \qquad \bigl(X\sim\text{Binomial}(3,\tfrac{1}{2})\bigr)$$

$$P_Y(y) = \frac{1}{2}, \quad y=0,1 \qquad \bigl(Y\sim\text{Bernoulli}(\tfrac{1}{2})\bigr)$$

**Nota:** $P(X=3,Y=1)=0 \neq P_X(3)\cdot P_Y(1)=\tfrac{1}{16}$ → $X$ e $Y$ **no son independientes**.
...
Para $y$ fijo, $x$ va de $0$ a $y$: $$f_Y(y) = \int_0^y e^{-y},dx = e^{-y}\cdot[x]_0^y = ye^{-y}$$
...
Integral externa: $$\int_2^4(e^{-x}-e^{-4}),dx = \left[-e^{-x}-xe^{-4}\right]_2^4 = (-5e^{-4})-(-e^{-2}-2e^{-4}) = e^{-2}-3e^{-4}$$

**Resultado:** $$P(X>2\mid Y<4) = \frac{e^{-2}-3e^{-4}}{1-5e^{-4}} = \frac{0.1353-0.0549}{0.9084}$$
