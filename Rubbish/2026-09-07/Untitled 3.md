...
> 🎬 **Video:** *"Harnessing the Earth: The Mechanics of Geothermal Power"* — duración 2:11 min
> ✂️ **[POSIBLE RECORTE]:** Si el tiempo es ajustado, considerar eliminar la Sección 1 (0:00–0:30 aprox.) — datos mundiales y mención a Chile que no son centrales para la exposición.
...
**Sección 3 — Separación y secado**
Una vez en la superficie, un equipo llamado separador recibe la mezcla de agua y vapor. Su función es dividir el flujo: envía el vapor hacia un secador donde se elimina toda la humedad, y dirige el agua líquida hacia una bomba que la devuelve al subsuelo.

**Sección 4 — Generación de electricidad**
El vapor, ahora completamente seco, es conducido a alta presión para impulsar una turbina. Esta turbina está conectada a un generador que, al girar por la fuerza del vapor, produce la energía eléctrica que finalmente consumimos.
...
*— Usa vapor extraído **directamente** del reservorio.*
*— Es la tecnología más **sencilla** de las tres.*
...
*— Su clave: la reducción de presión convierte el agua en vapor de forma instantánea.*
...
*— Su clave: usa un **fluido secundario** como butano o pentano que se vaporiza con menos calor, sin mezclar nunca el agua geotérmica con el circuito eléctrico.*
*— Su ventaja principal: permite aprovechar recursos que los otros dos tipos **no podrían usar**.*

*Y esto es directamente relevante para Bolivia — la **Planta Piloto de Laguna Colorada de 5 MW**, construida por Sacyr Industrial y Ormat, es precisamente una planta de **ciclo binario**. Aprovecha fluido geotérmico extraído a 1.490 metros de profundidad a una temperatura de **170°C** para generar electricidad. Es además la planta geotérmica ubicada a mayor altitud en el mundo — a **4.980 metros sobre el nivel del mar**. Es decir, el ciclo binario no es solo teoría para Bolivia — es la tecnología que ya está instalada en el país."*

> 📌 **Fuente:** Ecoticias / Sacyr Industrial — *"Planta geotérmica en Bolivia"* (2019) — https://www.ecoticias.com/eco-america/193260_planta-geotermica-en-bolivia
> Confirmado también en: Sacyr Blog — https://sacyr.com/en/-/extraemos-energia-de-las-profundidades-de-la-tierra-en-bolivia/blog
...
*— **Generación eléctrica** — el uso más conocido, para recursos de alta temperatura.*
*— **Calefacción** — calentamiento directo de viviendas, edificios e industrias.*
*— **Refrigeración** — mediante sistemas de absorción y bombas de calor.*
*— **Agua caliente** — para uso residencial, comercial e industrial.*
*— **Agricultura** — mantenimiento de temperaturas en invernaderos.*
...
*— **Bombas de calor geotérmicas** — aprovechan la temperatura estable del subsuelo para calefacción y refrigeración de edificios."*
