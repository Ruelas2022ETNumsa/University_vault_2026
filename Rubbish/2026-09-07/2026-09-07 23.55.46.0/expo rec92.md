...
*"Retomando lo que nos explicó Valeria sobre qué es la energía geotérmica y su contexto en Bolivia, me corresponde ahora cubrir tres puntos centrales: primero, cómo funciona paso a paso; segundo, los tres tipos de centrales que existen para convertir ese calor en electricidad; y tercero, los usos que tiene esta energía más allá de solo generar electricidad.*
...
*(2) **Perforación** — se perforan pozos que llegan hasta el reservorio donde se concentra ese calor.*
...
>"Ahora que ya entendemos cómo funciona el proceso, la pregunta es: ¿todas las plantas lo hacen igual? La respuesta es no — y eso nos lleva al segundo video."
...
Este método se utiliza cuando disponemos de agua calentada de forma geotérmica a temperaturas superiores a los 350 grados Fahrenheit.

A esta agua caliente y mineralizada la llamamos salmuera, y es transferida a un contenedor especial donde se produce el vapor.

Este vapor ~~como podemos observar~~ impulsa la turbina conectada al generador para producir electricidad, mientras que la salmuera restante o de desecho se reinyecta en la Tierra.

**Sección 4 — Planta de Ciclo Binario (Binary Cycle)**

El tercer tipo es la planta de ciclo binario. Se aplica cuando el recurso geotérmico está a temperaturas más bajas, de hasta 100 grados Fahrenheit. El agua caliente pasa por un intercambiador de calor donde transfiere su calor a un fluido secundario — como butano o pentano — sin que ambos líquidos se mezclen. Ese fluido secundario, al tener un punto de ebullición mucho menor, se vaporiza y mueve la turbina. Posteriormente, el vapor se enfría en un condensador para reciclar el fluido secundario, mientras que el agua residual se reinyecta en el subsuelo. Como el sistema opera con dos líquidos — el agua geotérmica y el fluido secundario — se le conoce como planta de ciclo binario.

```ad-note
collapse: closed

El tercer tipo es la planta de ciclo binario. Se aplica cuando el recurso (geotérmico) está a temperaturas más bajas (hasta 100 grados Fahrenheit).

El agua caliente pasa por un intercambiador de calor donde transfiere su calor a un fluido secundario — como butano o pentano — sin que ambos líquidos se mezclen.

El agua caliente pasa por un intercambiador de calor junto a un fluido secundario (con un punto de ebullición mucho menor)— como butano o pentano(pentane hydrocarbon) — . Ese fluido secundario se vaporiza y mueve la turbina.
...
*"Para resumir este primer tipo:

— Usa vapor extraído directamente del reservorio, a temperaturas superiores a los 150°C.
— Es la tecnología más sencilla y antigua de las tres.
— Su ventaja: alta eficiencia cuando el vapor es de buena calidad.
— Su limitación: los depósitos de vapor seco son extremadamente raros — por eso es la menos común a nivel mundial.
— En el caso de Bolivia, no se cuenta con este tipo de recurso, por lo que esta tecnología no aplica para el país."*

# Diapo 14 — Planta de Vapor Flash

*"Para resumir este segundo tipo:

— Es la tecnología más común a nivel mundial.
— Opera con agua a temperaturas superiores a 180°C.
— Su clave: al ascender a la superficie, la caída brusca de presión convierte el agua en vapor de forma instantánea — de ahí el nombre 'flash'.
— Su limitación: la salmuera puede requerir mayor mantenimiento en equipos y tuberías.
— Bolivia tampoco utiliza esta tecnología — el recurso geotérmico del país opera a temperaturas más bajas, lo que hace del ciclo binario la opción adecuada."*
...
Y esto es directamente relevante para Bolivia — la Planta Piloto de Laguna Colorada de 5,6 MW, construida por Sacyr Industrial y Ormat, es precisamente una planta de ciclo binario. Aprovecha fluido geotérmico extraído a 1.490 metros de profundidad a una temperatura de 170°C. Es además la planta geotérmica ubicada a mayor altitud en el mundo — a casi 5.000 metros sobre el nivel del mar. Y no es el final — esta planta piloto es el paso previo a una planta de 100 MW proyectada en el mismo campo geotérmico. Es decir, el ciclo binario no es solo teoría para Bolivia — es la tecnología que ya está instalada y que definirá el futuro energético del país."*

>"Más allá de generar electricidad, la geotermia tiene un alcance mucho mayor — y eso nos lleva a la última parte."
...
— Calefacción — calentamiento directo de viviendas, edificios e industrias. Islandia es el caso más notable: más del 90% de sus hogares se calefaccionan con esta fuente.
— Refrigeración — mediante sistemas de absorción y bombas de calor.
— Agua caliente — para uso residencial, comercial e industrial.
— Agricultura — mantenimiento de temperaturas en invernaderos, permitiendo cultivos durante todo el año incluso en climas fríos.
— Acuicultura — condiciones térmicas óptimas para cría de especies acuáticas.
— Procesos industriales — calor de baja y media temperatura para industria.
— Balnearios — uno de los usos históricos más antiguos.
— Bombas de calor geotérmicas — aprovechan la temperatura estable del subsuelo para calefacción y refrigeración de edificios, con potencial de reducir emisiones del sector hasta en un 30%."*
...
>Con esto concluye mi parte — hemos visto cómo funciona la geotermia, los tres tipos de plantas y sus múltiples usos. Le cedo la palabra a mi compañero.