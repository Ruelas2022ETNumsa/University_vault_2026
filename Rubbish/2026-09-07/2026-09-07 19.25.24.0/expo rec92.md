...
Su función enviar el vapor a un secador, donde se eliminaran todos los rastros de humedad, ademas dirige el agua a una bomba  que la devuelve al subsuelo 

es dividir el flujo: por un lado, envía el vapor hacia un secador, donde se eliminará por completo cualquier rastro de humedad, y por el otro lado, dirige el agua líquida hacia una bomba que la devuelve al subsuelo.
