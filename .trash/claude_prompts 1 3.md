...
> Usar al iniciar una sesión de planificación de proyectos. Define el flujo para crear o retomar un `tsk_`, discutir el enfoque con el usuario y escribir el contenido en el archivo correspondiente.
