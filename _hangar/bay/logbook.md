...
| :------------: | :----: | :------: | :------------------------------------------------ | :--: | :-----: |
| [[alx_hot.md]] |   ❌    |    🔴    | Sistema consulta móvil via Drive MCP              |      |  23:20  |
|  [[krajo.md]]  |   ❌    |    🔴    | Implementación física `_hangar/`                  |      |  1:00   |
| [[alx_gml.md]] |   ❌    |    🔴    | Sistema de links, sync y organización de carpetas |      |  4:30   |
| [[alxrul.md]]  |   ✔    |    🟢    | —                                                 |      |         |
