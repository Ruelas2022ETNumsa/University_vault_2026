...
| :------------: | :----: | :------: | :------------------------------------------------ | :--: | :-----: |
| [[alx_hot.md]] |   ❌    |    🔴    | Sistema consulta móvil via Drive MCP              |      |  22:00  |
|  [[krajo.md]]  |   ❌    |    🔴    | Implementación física `_hangar/`                  |      |  23:50  |
| [[alx_gml.md]] |   ❌    |    🔴    | Sistema de links, sync y organización de carpetas |      |  2:20   |
| [[alxrul.md]]  |   ✔    |    🟢    | —                                                 |      |         |
