...
$$I = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}\text{ (matriz identidad) }$$
$$0 = \begin{bmatrix} 0 & 0 \\ 0 & 0 \end{bmatrix}\text{(matriz con tan solo ceros)}$$
 $$A = \begin{bmatrix} 0.6 & 0 \\ 0.4 & 0.1 \end{bmatrix}$$ 
 $$B = \begin{bmatrix} 0.2 & 0.2 \\ 0.3 & 0.2 \end{bmatrix}$$


La matriz fundamental se calcula como:**$$F = (I - B)^{-1}$$
Veamos cómo se calcula para la aplicación de cuentas por cobrar:$$F = (I - B)^{-1}$$

o bien $F = \left( \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix} - \begin{bmatrix} 0.2 & 0.2 \\ 0.3 & 0.2 \end{bmatrix} \right)^{-1}$ Al restar $B$ de $I$: $F = \begin{bmatrix} 0.8 & -0.2 \\ -0.3 & 0.8 \end{bmatrix}^{-1}$
...
Para encontrar la matriz $F$: 
$r = ad - bc = (0.8)(0.8) - (-0.2)(-0.3) = 0.64 - 0.06 = 0.58$ 

$F = \begin{bmatrix} \frac{0.8}{0.58} & -\frac{-0.2}{0.58} \\ -\frac{-0.3}{0.58} & \frac{0.8}{0.58} \end{bmatrix} = \begin{bmatrix} 1.38 & 0.34 \\ 0.52 & 1.38 \end{bmatrix}$

Ahora estamos en posición de usar la matriz fundamental para calcular la cantidad de dinero en deuda incobrable que esperaríamos a la larga. Primero necesitamos multiplicar la matriz fundamental, $F$, por la matriz $A$. Esto se logra como sigue: 

$FA = \begin{bmatrix} 1.38 & 0.34 \\ 0.52 & 1.38 \end{bmatrix} \times \begin{bmatrix} 0.6 & 0 \ 0.4 & 0.1 \end{bmatrix}$ es decir; $FA = \begin{bmatrix} 0.97 & 0.03 \\ 0.86 & 0.14 \end{bmatrix}$
