...
1. Según los axiomas de cuerpo, ¿cómo se define formalmente la operación de división?
2. Si la división por cero no está definida, ¿qué sucede con la gráfica de una función racional cuando su denominador se acerca a cero?
3. ¿Por qué el "cuerpo trivial" (donde $1 = 0$) no es útil para el cálculo en ingeniería?

### Ejercicios de refuerzo

**Ejercicio 1 (Thomas 14ed, 2.6):** Determine el dominio de la función $f(x) = \frac{x^2 + x - 2}{x^2 - x}$. Identifique los puntos donde la división por cero impide que la función esté definida.
...
**Ejercicio 2 (Apostol Vol 1, I 3.3):** Demuestre que si $a \cdot b = 0$, entonces necesariamente $a = 0$ o $b = 0$. ¿Cómo se relaciona esto con la imposibilidad de tener un recíproco para el cero?.
